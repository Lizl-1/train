package com.lizl.train.${module}.service;
...
import com.lizl.train.${module}.domain.${Domain};
import com.lizl.train.${module}.domain.${Domain}Example;
import com.lizl.train.${module}.mapper.${Domain}Mapper;
